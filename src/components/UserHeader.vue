    ...
    <div class="upload__heading">
      <div class="upload__heading_content user__heading">
        <div class="user__links">
          <svg class="user__pic" width="84" height="84" x="0px" y="0px" viewBox="0 0 64 64" style="enable-background:new 0 0 64 64;" xml:space="preserve">
            <g id="Layer_1">
              <g>
        ...
        <div class="user__links">
          <svg class="user__pic" version="1.1" id="Layer_1" x="0px" y="0px" width="84" height="84"
            ...
            <g>
              <path style="fill:none;" d="M256,0C114.616,0,0,114.616,0,256s114.616,256,256,256s256-114.616,256-256S397.384,0,256,0L256,0z"
                />
              <path style="fill:none;" d="M256,512c122.573,0,224.968-86.164,250.061-201.216l0,0
              ...
              <path style="fill:var(--blue-grey-lighter);" d="M185.37,247.649v54.083c0,35.968,26.895,65.638,61.665,70.042v43.607h17.925v-43.607
              ...
              <path style="fill:#0E8594;" d="M326.63,247.649L326.63,247.649H256v124.713c3.036,0,6.026-0.189,8.96-0.563v-0.02
                ...
                v-54.088H326.63z"/>
              <path style="fill:var(--blue-grey-light);" d="M256,247.649v167.736h8.96v-43.607c34.775-4.408,61.665-34.074,61.665-70.042v-54.088H256z"/>
          ...
          <h1 class="user__title">Adverisement</h1>
        </div>

        <div class="user__links">
          <svg class="user__pic" version="1.1" id="Layer_1" idth="84" height="84" x="0px" y="0px"
              viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
            <g>
              <circle style="fill:none;" cx="256" cy="256" r="256"/>
              <path style="fill:none;" d="M512,256c0-13.809-1.126-27.346-3.231-40.561l-0.323-0.323
              ...
              <path style="fill:var(--blue-grey-light);" d="M388.316,122.982H123.684c-8.929,0-16.169,7.24-16.169,16.169v255.304
              ...
              <path style="fill:var(--blue-grey-lighter);" d="M388.316,101.376H123.684c-8.929,0-16.169,7.24-16.169,16.169v255.304
              ...
              <polygon style="fill:#2C5871;" points="256,101.376 162.688,101.376 162.688,389.018 256,389.018 349.312,389.018 349.312,101.376 
                  "/>
              <circle style="fill:var(--blue-grey-lighter);" cx="256" cy="143.411" r="20.746"/>
              <circle style="fill:var(--blue-grey-lighter);" cx="256" cy="236.083" r="12.078"/>
              <circle style="fill:var(--blue-grey-lighter);" cx="191.13" cy="134.728" r="12.078"/>
              <circle style="fill:var(--blue-grey-lighter);" cx="191.13" cy="176.225" r="12.078"/>
              <circle style="fill:var(--blue-grey-lighter);" cx="191.13" cy="217.718" r="12.078"/>
              <circle style="fill:var(--blue-grey-lighter);" cx="320.87" cy="134.728" r="12.078"/>
              <circle style="fill:var(--blue-grey-lighter);" cx="320.87" cy="176.225" r="12.078"/>
              <circle style="fill:var(--blue-grey-lighter);" cx="320.87" cy="217.718" r="12.078"/>
