...
<!--           <svg class="user__pic"  :class="getSelectedMenu == 1 ? 'selected__pic' : ''" width="84" height="84" x="0px" y="0px" viewBox="0 0 64 64" style="enable-background:new 0 0 64 64;" xml:space="preserve">
          ...
          <svg class="user__pic"  :class="getSelectedMenu == 1 ? 'selected__pic' : ''" x="0px" y="0px"
              width="84.239px" height="84.238px" viewBox="0 0 141.239 141.238" style="enable-background:new 0 0 141.239 141.238;"
              xml:space="preserve">
            <g>
              <path class="st13" d="M6.616,106.26c0,0,12.69,1.544,16.944,1.539c3.915,0,9.738,0.164,18.714-6.567c0,0,1.317,7.558,8.887,12.871
